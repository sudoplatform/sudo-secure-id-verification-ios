...
public struct SudoIdentityVerificationClientConfigProvider: AWSAppSyncServiceConfigProvider {
    ...
    /// Initializes `SudoIdentityVerificationClientConfigProvider` with the API endpoint URL
    /// and AWS region type.
    ///
    /// - Parameters:
    ///   - endpoint: URL for Sudo Identity Verification API endpoint.
    ///   - region: AWS region.
    ...
    /// and AWS region type.
    ///
    /// - Parameter config: Configuration parameters for Sudo  Identity Verification API endpoint.
